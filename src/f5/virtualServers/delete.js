...
class Delete extends React.Component {
  ...
  deleteVirtualServer = async virtualServer => {
    ...
    await rest.doXHR(`f5/${this.props.asset.id}/${this.props.partition}/virtualserver/${this.props.obj.name}/`, this.props.token )
  }
  ...
  render() {
    ...
    return (
      <Space direction='vertical'>
        ...
        <Modal
          title={<p style={{textAlign: 'center'}}>DELETE PROFILE</p>}
          centered
          destroyOnClose={true}
            ...
            <div>
              ...
              <Row>
                <Col span={2} offset={10}>
                  <Button type="primary" onClick={() => this.deleteVirtualServer(this.props.obj)}>
                    YES
                  </Button>
                </Col>
                <Col span={2} offset={1}>
