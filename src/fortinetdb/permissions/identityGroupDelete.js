...
class IdentityGroupDelete extends React.Component {
  ...
  identityGroupDelete = async () => {
    ...
    await rest.doXHR(`fortinetdb/identity-group/${this.state.identity_group_identifier}/`, this.props.token)
  }
...
export default connect((state) => ({
  ...
  identityGroupDeleteError: state.fortinetdb.identityGroupDeleteError,
}))(IdentityGroupDelete);
