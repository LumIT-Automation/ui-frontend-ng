...
class Manager extends React.Component {
  ...
  historyGet = async () => {
    ...
    await rest.doXHR("workflow/history/", this.props.token)
    return r
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        { this.props.historysError ? <Error component={'manager workflow'} error={[this.props.historysError]} visible={true} type={'historysError'} /> : null }
...
export default connect((state) => ({
  ...
  historys: state.workflow.historys,
  historysError: state.workflow.historysError,
  historysFetch: state.workflow.historysFetch,
