  ...
  render() {
    return (
      <React.Fragment>
        ...
        { this.props.assetsError ? <Error component={'asset manager checkpoint'} error={[this.props.assetsError]} visible={true} type={'assetsError'} /> : null }
...
export default connect((state) => ({
  ...
  assetsFetch: state.checkpoint.assetsFetch
}))(Manager);
