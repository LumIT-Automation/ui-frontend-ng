...
class Modify extends React.Component {
  ...
  assetModify = async () => {
    ...
    await rest.doXHR(`checkpoint/asset/${this.props.obj.id}/`, this.props.token, b )
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.visible ?
          <React.Fragment>
            { this.props.assetModifyError ? <Error component={'asset modify checkpoint'} error={[this.props.assetModifyError]} visible={true} type={'assetModifyError'} /> : null }
          </React.Fragment>
        :
          null
        }
...
export default connect((state) => ({
  token: state.authentication.token,
 	assetModifyError: state.checkpoint.assetModifyError,
}))(Modify);
