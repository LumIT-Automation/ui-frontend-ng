...
class Delete extends React.Component {
  ...
  datacenterServerDelete = async datacenterServer => {
    ...
    await rest.doXHR(`checkpoint/${this.props.asset.id}/${this.props.domain}/datacenter-server/${this.props.obj.uid}/`, this.props.token )
  }
            ...
            <div>
              ...
              <Row>
                <Col span={2} offset={10}>
                  <Button type="primary" onClick={() => this.datacenterServerDelete(this.props.obj)}>
                    YES
                  </Button>
                </Col>
                <Col span={2} offset={1}>
