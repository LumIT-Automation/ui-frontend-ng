...
class Add extends React.Component {
  ...
  assetAdd = async () => {
    ...
    await rest.doXHR(`vmware/assets/`, this.props.token, b )
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.visible ?
          <React.Fragment>
            { this.props.assetAddError ? <Error component={'asset add vmware'} error={[this.props.assetAddError]} visible={true} type={'assetAddError'} /> : null }
          </React.Fragment>
        :
          null
        }
...
export default connect((state) => ({
  token: state.authentication.token,
 	assetAddError: state.vmware.assetAddError,
}))(Add);
