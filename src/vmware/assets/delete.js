...
class Delete extends React.Component {
  ...
  assetDelete = async asset => {
    ...
    await rest.doXHR(`vmware/asset/${asset.id}/`, this.props.token )
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.visible ?
          <React.Fragment>
            { this.props.assetDeleteError ? <Error component={'asset delete vmware'} error={[this.props.assetDeleteError]} visible={true} type={'assetDeleteError'} /> : null }
          </React.Fragment>
        :
          null
        }
...
export default connect((state) => ({
  token: state.authentication.token,
 	assetDeleteError: state.vmware.assetDeleteError,
}))(Delete);
