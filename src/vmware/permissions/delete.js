...
class Delete extends React.Component {
  ...
  permissionDelete = async () => {
    ...
    await rest.doXHR(`vmware/permission/${this.props.obj.id}/`, this.props.token )
  }
  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.visible ?
          <React.Fragment>
          { this.props.permissionDeleteError ? <Error component={'delete vmware'} error={[this.props.permissionDeleteError]} visible={true} type={'permissionDeleteError'} /> : null }
          </React.Fragment>
        :
          null
        }
...
export default connect((state) => ({
  token: state.authentication.token,
 	permissionDeleteError: state.vmware.permissionDeleteError,
}))(Delete);
