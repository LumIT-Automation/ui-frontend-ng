...
class IdentityGroupDelete extends React.Component {
  ...
  identityGroupDelete = async () => {
    ...
    await rest.doXHR(`vmware/identity-group/${this.state.identity_group_identifier}/`, this.props.token)
  }
...
export default connect((state) => ({
  ...
  identityGroupDeleteError: state.vmware.identityGroupDeleteError,
}))(IdentityGroupDelete);
